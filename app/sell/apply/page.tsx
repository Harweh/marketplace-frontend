...
export default function ApplySellerPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true)
        try {
            await applyAsVendor({ storeName, description })
            setSubmitted(true)
        } catch (err) {
    ...
    if (checking) {
        return <div className="max-w-lg mx-auto px-4 py-20 text-center text-neutral-500">Loading...</div>
    }
        ...
        <div className="max-w-lg mx-auto px-4 py-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-3 bg-black hover:bg-primary-40 disabled:opacity-50 text-white font-semibold rounded-lg"
                >
